...
<body>
    ...
    <h3>В названии изобретений и ответах используйте только заглавные и прописные английские буквы и пробел</h3>
    <table>
        ...
        <tr><th align="left">Если хотите ответить на предложение корректировки, отправьте ответ сюда:</th></tr>
        <tr>
        <td>
            <form method = "post" enctype="multipart/form-data">
            <lable>Название изобретения:</lable>
            ...
            <lable>Кому:</lable>
            <input type = "radio" value="ev" name = "reciever" >Оценщику</input>
            <input type = "radio" value = "red" name = "reciever" >Редактору</input>
            <lable>Ответ:</lable>
